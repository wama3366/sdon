...
using IdentityAndAccess.API.Ui.Pages.Consent;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Microsoft.Extensions.Options;
using InputModel = IdentityAndAccess.API.Ui.Pages.Device.InputModel;
using ScopeViewModel = IdentityAndAccess.API.Ui.Pages.Device.ScopeViewModel;
using ViewModel = IdentityAndAccess.API.Ui.Pages.Device.ViewModel;

namespace IdentityAndAccess.API.Ui.Pages.Device;
...
public class Index : PageModel
{
    ...
    private ViewModel CreateConsentViewModel(DeviceFlowAuthorizationRequest request)
    {
        var vm = new ViewModel
        {
            ...
            IdentityScopes = [.. request.ValidatedResources.Resources.IdentityResources.Select(x => CreateScopeViewModel(x, Input == null || Input.ScopesConsented.Contains(x.Name)))]
        };
