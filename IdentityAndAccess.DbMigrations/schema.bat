...
dotnet ef migrations add AspIdentity -c AspIdentityDbContext -o Migrations/AspIdentityDb
...
dotnet ef migrations script -c AspIdentityDbContext -o Migrations/AspIdentityDb.sql
